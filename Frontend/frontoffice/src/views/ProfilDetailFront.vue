...
<div class="row py-5 px-4">
    <div class="">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <div class="row">
                      <h5 class="" style="margin-bottom:5%;">Liste des Enquetes aux quels vous participez</h5>
...
<b-table striped hover :items="listeenqueteurs" :fields="fields"  :per-page="perPage"
      :current-page="currentPage">
          ...
          <router-link :to="`detailEnqueteur/${row.item.id}/${id}`">Details</router-link>
          </template>
    ...
    <ul id="example-1">
  <li>
      Cliquez votre détail pour voire votre performance sur ses enquetes
  </li>
</ul>
    </b-media>
...
export default {
    ...
    created() {
     ...
     axios.get("http://127.0.0.1:8000/enumerator_detail/"+ idenumerator)
        .then(response => {
       ...
       .catch(function (error) {
         ...
         axios.get("http://127.0.0.1:8000/getEnumeratorDetail/"+ idenumerator)
        .then(response => {
  ...
  axios.get("http://127.0.0.1:8000/getSurveyByEnumerator/"+idenumerator)
        .then(response => {
